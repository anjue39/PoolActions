...
#1.数据url
url = 'https://sub.xeton.dev/sub?target=clash&new_name=true&url=https://raw.githubusercontent.com/anjue39/PoolActions/main/subscribe/clash0.txt&config=https://raw.githubusercontent.com/anjue39/openit/main/utils/subconverter/config/rule_mini.ini&emoji=true&list=false&udp=false&tfo=false&scv=false&fdn=false&sort=false'
#2.添加请求头
headers = {
